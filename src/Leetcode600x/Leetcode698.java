...
​N
​​ ), where NN is the length of nums. There are 2^N2
​N
​​  states of used (or state in our bottom-up variant), and each state performs O(N) work searching through nums.

Space Complexity: O(2^N)O(2
​N
​​ ), the space used by memo (or dp, total in our bottom-up variant).
