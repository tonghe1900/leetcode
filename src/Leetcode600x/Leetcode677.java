...
Time Complexity: Every insert operation is O(K^2)O(K
​2
​​ ), where KK is the length of the key, as KK strings are made of an average length of KK. Every sum operation is O(1)O(1).
