 ...
 * update(int input[], int segment[], int indexToBeUpdated, int newVal) - updates input and segmentTree 
 * with newVal at index indexToBeUpdated;
 * updateRange(int input[], int segment[], int lowRange, int highRange, int delta) - updates all the values 
 * in given range by
 ...
 */
 ...
 class SegmentTreeMinimumRangeQuery {
    ...
    public int[] createSegmentTree(int input[]){
        ...
        int segmentTree[] = new int[nextPowOfTwo*2 -1];  //nextPowOfTwo*2-1   // int segmentTree[] = new int[nextPowOfTwo*2 -1];
// int segmentTree[] = new int[nextPowOfTwo*2 -1]
        //        int nextPowOfTwo = np2.nextPowerOf2(input.length);
//        int segmentTree[] = new int[nextPowOfTwo*2 -1];
...
public class LeetCode307SegmentTree {

    public int[] createTree(int input[], Operation operation){
        int height = (int)Math.ceil(Math.log(input.length)/Math.log(2));//Math.log(input.length)/Math.log(2)
        //Math.ceil( Math.log(input.length) / Math.log(2))
        //int height = (int)Math.ceil(Math.log(input.length)/Math.log(2));
        int segmentTree[] = new int[(int)(Math.pow(2, height+1)-1)];
        //  2* Math.pow(2, height) -1    //  Math.pow(2, height+1) - 1
    ...
    public static void main(String args[]){
        ...
        LeetCode307SegmentTree st = new LeetCode307SegmentTree();
