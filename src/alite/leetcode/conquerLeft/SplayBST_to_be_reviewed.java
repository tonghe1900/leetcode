 ...
 * @param <Value>
 */
public class SplayBST_to_be_reviewed<Key extends Comparable<Key>, Value>  {
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        SplayBST_to_be_reviewed<Integer, Integer> st1 = new SplayBST_to_be_reviewed<Integer, Integer>();
        st1.put(5, 5);
        st1.put(9, 9);
        st1.put(13, 13);
        st1.put(11, 11);
        ...
        SplayBST_to_be_reviewed<String, String> st = new SplayBST_to_be_reviewed<String, String>();
