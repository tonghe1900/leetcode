 ...
 * by water, and there is exactly one island (i.e., one or more connected land cells). The island 
 * doesn't have "lakes" (water inside that isn't connected to the water around the island).
