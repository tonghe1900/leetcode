...
public class LeetCode464CanIWin {
	...
	public static void main(String[] args) {
		...
		System.out.println(new LeetCode464CanIWin().canIWin(10, 11));
...
//		boolean isMe;
//		int currentTotal;
//		PriorityQueue<Integer> pg;
//		TreeSet<Integer> choosen = new TreeSet<Integer>();
//		public State(boolean isMe, int currentTotal, PriorityQueue<Integer> pg,
//				TreeSet<Integer> choosen) {
//			super();
//			this.isMe = isMe;
...
//		}
//		
//		State initialState = new State(true, desiredTotal, pg, new TreeSet<Integer>());
//		return canIWin(initialState, new HashMap<String, Boolean>());
//	}
//	
//	private String createKey(TreeSet<Integer> choosen, int currentTotal, boolean isMe){
...
//	}
//
//	private boolean canIWin(State state ,  Map<String, Boolean> cache) {
//		TreeSet<Integer> choosen = state.choosen;
//		int currentTotal = state.currentTotal;
//		boolean isMe = state.isMe;
//		PriorityQueue<Integer> pg = state.pg;
//		String key = createKey(choosen, currentTotal, isMe);
//		if(cache.containsKey(key)){
//			return cache.get(key);
//		}
//		if(pg.peek() >= currentTotal) return isMe;
//		for(int i: pg){
//			if(isMe){
//				if(canIWin(new State()))
//			}
//		}
//		return false;
//	}
