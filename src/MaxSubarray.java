...
public class MaxSubarray {
	...
	public int []  getMaxIntervalDP(int a[]){
		int start = 0; int end = 0; int minSum =Math.min(0, a[0]) ; int minSumEndingIndex = a[0] < 0? 0: -1 ;
    ...
    // the smallest consecutive subarray whose sum is bigger than k
    // the largest consecutive subarray whose sum is <= k
...
//		System.out.println(sum);
		...
		int result  = (new MaxSubarray().maxSubarraySumInCircular2(list));
//		int sum = 0;
//		for(int element: result){
//			sum +=element;
//			System.out.print(element + ",");
